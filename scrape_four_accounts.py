#!/usr/bin/env python3
"""
Scrape 4 TikTok accounts from 12/1/25
Generate statistics categorized by sound usage and views
"""
...
def main():
    # Start date: 12/1/25 midnight
    start_date = datetime(2025, 12, 1, 0, 0)
    end_date = datetime.now()

    accounts = {
        'earl.boone1': 'Earl Boone',
        'brew.pilled': 'Brew Pilled',
        'trailheadtravis': 'Trailhead Travis',
        'dirtroad.drivin': 'Dirtroad Drivin'
    }

    print("=" * 80)
    print("SCRAPING 4 TIKTOK ACCOUNTS")
    print("=" * 80)
    ...
    stats_file = output_dir / f'four_accounts_stats_{timestamp}.txt'
    links_file = output_dir / f'four_accounts_all_links_{timestamp}.txt'
    ...
    with open(stats_file, 'w', encoding='utf-8') as f:
        f.write("4 TIKTOK ACCOUNTS - STATISTICS\n")
        f.write("=" * 80 + "\n\n")
    ...
    with open(links_file, 'w', encoding='utf-8') as f:
        f.write("4 TIKTOK ACCOUNTS - ALL VIDEO LINKS\n")
        f.write("=" * 80 + "\n")
