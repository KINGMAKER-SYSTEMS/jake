"""
Scraper for Therapy by December Falls Campaign
Sound URL: https://www.tiktok.com/music/Therapy-7444366568778598416
...
sound_url = "https://www.tiktok.com/music/Therapy-7444366568778598416"
...
if all_matching_videos:
    output_file = f"output/therapy_december_falls_{datetime.now().strftime('%Y%m%d_%H%M%S')}.csv"
